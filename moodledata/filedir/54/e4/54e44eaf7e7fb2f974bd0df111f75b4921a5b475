...
#COMECE AQUI ABAIXO
 ...
 #Equipe: Gabriel Menezes Amorim; Kamille Peixoto de Melo Nascimento; Jasiel Pereira dos Santos 
 #Matrículas: 390777; 381486; 381482                                                            
 #Exercício-Programa 1 -- Números Felizes                                                       
 #EM0006 (EM) -- 2017 -- Professor: Rafael Perazzo                                              
    ...
    while numero > 0:                       #comando para que o processamento dentro da tabulação seja executado enquanto atender a condiçao
        ...
        if lista_b[len(lista_b)-1] == 1:    #condição para que o dado de entrada seja um número feliz
            return(True,lista_b)            #retornando 'verdadeiro' caso a condição anterior seja atendida
                                            ...
                                            #o número 4 foi utilizado pois é preciso que haja um parâmetro de comparação para quando o número não é feliz, pois a soma dos quadrados dos seus algarismos nunca séra e ocorrerá infinitamente
...
#condição contrária. Caso a condição aterior nçao for atendida esta entrará em vigor
else:
