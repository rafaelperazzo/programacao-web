...
class __Mustache_a0d450dc8ec823101f2175067117923c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE0e760c6724dcbfa047922054e98e24a($context, $indent, $value);
...
';
    ...
    private function sectionE0e760c6724dcbfa047922054e98e24a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
                $buffer .= $indent . '    $(\'.tag_list .tagmorelink\').click(function() {
';
                $buffer .= $indent . '        $(this).closest(\'.tag_list\').removeClass(\'hideoverlimit\');
';
                $buffer .= $indent . '    });
';
                $buffer .= $indent . '    $(\'.tag_list .taglesslink\').click(function() {
';
