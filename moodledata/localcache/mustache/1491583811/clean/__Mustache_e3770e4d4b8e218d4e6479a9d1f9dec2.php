...
class __Mustache_e3770e4d4b8e218d4e6479a9d1f9dec2 extends Mustache_Template
{
...
';
        // 'duedate' section
        $value = $context->find('duedate');
        $buffer .= $this->section131cda75d2bc5c7856dea0bbe8d3a9ff($context, $indent, $value);
        $buffer .= $indent . '</span>
';
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section131cda75d2bc5c7856dea0bbe8d3a9ff(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<br/><small data-region="assignment-tooltip" aria-describedby="tooltip-';
                $value = $this->resolveValue($context->find('uniqid'), $context);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '">';
                // 'str' section
