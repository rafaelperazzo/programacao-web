...
def decrescente(s):
    for i in range(0,n-1,1):
        if i>(i+1):
            s=s+1
            decresc_q=decresc_q+1
    return s
def elemconsc(t):
    for i in range(0,n-1,1):
        if i==(i+1):
            t=t+1
            elemconsc_q=elemconsc_q+1
    return t
...
decresc_q=(a[i])
elemconsc_q=(a[i])
if crescente(r)>0 and crescente(r)==n and elemconsc(t)==0 and cresc_q==n:
    print('S')
else :
    print('N')
if decrescente(s)>0 and decrescente(s)==n and elemconsc(t)==0 and decresc_q==n:
    print('S')
else :
    print('N')
if elemconsc(t)>0:
