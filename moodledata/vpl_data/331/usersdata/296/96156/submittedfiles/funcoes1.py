...
if crescente(a,len(a)):
    print ("S")
else:
    print("N")
if crescente(b,len(b)):
    print ("S")
else:
    print("N") 
if crescente(c,len(c)):
    print ("S")
else:
    print("N")
if decrescente(a,len(a)):
    print ("S")
else:
    print("N")
if decrescente(b,len(b)):
    print ("S")
else:
    print("N")
if decrescente(c,len(c)):
    print ("S")
else:
    print("N")
if consecutivos_iguais(a,len(a)):
    print ("S")
else:
    print("N")
if consecutivos_iguais(b,len(b)):
    print ("S")
else:
    print("N")
if consecutivos_iguais(c,len(c)):
    print ("S")
else:
    print("N")
