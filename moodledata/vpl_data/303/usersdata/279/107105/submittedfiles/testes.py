# -*- coding: utf-8 -*-
#COMECE AQUI ABAIXO
print('Bem vindo ao JogoDaVelha do grupo H')
...
while (True) :
 ...
 while(True):
  if resultado!='L' :
      break
  simbolo=(input('Qual simbolo voce deseja utilizar no jogo? '))
 ...
 while(True) :
  ...
  while(True):
    ...
    if sorteio!=simbolo :
        while(True) :
            if b==0 :
             jogada=((input('Qual sua jogada %s '%nome)))
              ...
              for j in range (0,3,1):
                ...
                if jogada==posicao[i][j] :
                   if imagem[i][j]==' ' :
                       ...
                       b=1
             if b==0 :
                 print('OPS!!! Essa jogada nao esta disponivel Tente novamente!')
             for i in range(0,3,1) :
             ...
             while(True) :
                if resultado=='N':
                  for i in range(0,3,1) :
                      print('%s|%s|%s'%(imagem[i][0],imagem[i][1],imagem[i][2]))
