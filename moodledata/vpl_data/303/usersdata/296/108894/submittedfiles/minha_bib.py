...
def jogadaHumana(tabuleiro):
    movimento = 0
    while movimento!="1" and movimento!="2" and movimento!="3" and movimento!="4" and movimento!="5" and movimento!="6" and movimento!="7" and movimento!="8" and movimento!="9" :
        movimento=input("\nQual a sua jogada? ")
        while movimento or not vazio(tabuleiro, int(movimento)):
