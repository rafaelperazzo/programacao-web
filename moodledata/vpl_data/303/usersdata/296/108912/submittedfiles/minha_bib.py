...
def jogadaHumana(tabuleiro):
    movimento=str(input("\nQual a sua jogada? "))
    while (movimento!="0 0" and movimento!="0 1" and movimento!="0 2" and movimento!="1 0" and movimento!="1 1" and movimento!="1 2" and movimento!="2 0" and movimento!="2 1" and movimento!="2 2") or not vazio(tabuleiro, int(movimento)):
