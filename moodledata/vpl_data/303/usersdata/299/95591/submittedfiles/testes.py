...
for i in range(9):
    jogada1=str(input('Qual a sua jogada, '+nome1+'?'))
    i=jogada1[int(0)]
    j=jogada1[int(1)]
    tabuleiro[i][j]=s1
    print('',tabuleiro[0][0],'|',tabuleiro[0][1],'|',tabuleiro[0][2],'\n',tabuleiro[1][0],'|',tabuleiro[1][1],'|',tabuleiro[1][2],'\n',tabuleiro[2][0],'|',tabuleiro[2][1],'|',tabuleiro[2][2])
    ...
    if verificar_vitoria==True:
        print('Parabéns, você venceu, '+nome1+'?')
        break
    
    jogada2=str(input('Qual a sua jogada,'+nome2+'?'))
    i=jogada2[0]
    j=jogada1[1]
    tabuleiro[int(i)][int(j)]=s2
    print('',tabuleiro[0][0],'|',tabuleiro[0][1],'|',tabuleiro[0][2],'\n',tabuleiro[1][0],'|',tabuleiro[1][1],'|',tabuleiro[1][2],'\n',tabuleiro[2][0],'|',tabuleiro[2][1],'|',tabuleiro[2][2])
    verificar_vitoria(tabuleiro)
    if verificar_vitoria==True:
        print('Parabéns, você venceu '+nome2)
        break
