...
def jogadaHumana(tabuleiro):
    movimento=0
    while movimento not in '1' or movimento not in '2' or movimento not in '3' or movimento not in '4' or movimento not in '5' or movimento not in '6'or movimento not in '7' or movimento not in '8' or movimento not in '9' 
        movimento=input("\nQual a sua jogada?")
