...
if (float(qntd68)>=float(68/100)) and (float(qntd95)>=float(95/100) and (float(qntd997)>=float(99.7/100):
    print('Sim, a distruição é normal.')
if not (float(qntd68)>=float(68/100)) and (float(qntd95)>=float(95/100) and (float(qntd997)>=float(99.7/100):
