...
def validaJogada_H (nome,jh):
    while (jh!='00' or jh!='01' or jh!='02' or jh!='10' or jh!='11' or jh!='12' or jh!='20' or jh!='21' or jh!='22'):
        jh = str(input('Qual sua jogada, '+nome+'? '))
    return jh
