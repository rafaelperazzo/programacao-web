...
recorteMenorColuna=menorColuna(matriz)
recorteMaiorColuna=maiorColuna(matriz)

print(matriz[recorteMenorLinha:recorteMaiorLinha+1,recorteMenorColuna:recorteMaiorColuna+1])