...
c=np.zeros[linhadecima:linhadebaixo+1,colunaesquerda:colunadireita+1]

for i in range(linhadecima,linhadebaixo+1,1):
    for j in range(colunaesquerda,colunadireita+1,1):
        c[i,j]=a[i,j]
