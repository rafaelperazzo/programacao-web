...
#Função que irá desempenhar a funcionalidade pedida no programa
def multiplos(n, a, b):
    mult_a, mult_b, mult_a_b, cont_mult, cont = [], [], [], [], 0
    ...
    mult_a_b.sort()
    while cont < n:
        if mult_a_b[cont] in cont_mult:
            cont +=1
            n +=1
            continue
        print(mult_a_b[cont])
        cont_mult.append(mult_a_b[cont])
        cont +=1
