...
vcum=(l[0][0]+l[1][0]+l[2][0]+l[3][0])
vcdois=(l[0][1]+l[1][1]+l[2][1]+l[3][1])
vctres=(l[0][2]+l[1][2]+l[2][2]+l[3][2])
vcquatro=(l[0][3]+l[1][3]+l[2][3]+l[3][3])
if vcum>vc2 and vc1>vc3 and vc1>vc4:
