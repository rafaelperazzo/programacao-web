...
x6=int(input('digite um número:'))
x7=int(input('digite um número:'))
...
y6=int(input('digite um número:'))
y7=int(input('digite um número:'))
totallista2=y1+y2+y3+y4+y5
if x1<=x2 and x4>=x3 and x4>=x5 and x6>=x7 and totallista2>=10:
    print('S')
    print('N')
else:
    print('N')
