...
'''
Dfinal=def definicao_do_D(f, g, v, Q, dH, L,)
ffinal=def definicao_do_f(f, g, v, Q, dH, L,)

        
    print (funcoes.definicao_do_D(f,g,v,Q,dH,L,))
    print (funcoes.definicao_do_f(f,g,v,Q,dH,L,))
