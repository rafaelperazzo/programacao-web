...
for i in range(0,k,1):
    ...
    if f==fn: # Se o valor fixo 'f' for igual ao fator de atrito calculado, o programa é interrompido. Caso contrário, é repetido 'k' vezes
        break
    else:
        f==fn # Se 'f' for diferente de 'fn' calculado, então retorna-se ao primeiro passo, usando 'fn' como novo f
