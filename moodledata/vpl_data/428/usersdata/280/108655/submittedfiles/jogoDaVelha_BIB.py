...
def validaJogada(play, tab, name,):
    if play<0 or play>22 or type(play) is not int:
...
def jogadaboa(simb, tab):
    if tab[0][0]== " " and tab[1][0]== " " and tab[2][0]== " " and tab[0][1]== " " and tab[1][1]== " " and tab[2][1]== " " and tab[0][2]== " " and tab[1][2]== " " and tab[2][2]== " ":
        tab[1][1]=simb[1]
    elif tab[0][2] == " " and tab[0][0]==tab[0][1]==simb[1]:
        tab[0][2]=simb[1]
    elif tab[0][1] == " " and tab[0][0]==tab[0][2]==simb[1]:
        tab[0][1]=simb[1]
    elif tab[0][0] == " " and tab[0][1]==tab[0][2]==simb[1]:
        tab[0][0]=simb[1]
    elif tab[1][2] == " " and tab[1][0]==tab[1][1]==simb[1]:
        tab[1][2]=simb[1]
    elif tab[1][1] == " " and tab[1][0]==tab[1][2]==simb[1]:
        tab[1][1]=simb[1]
    elif tab[1][0] == " " and tab[1][1]==tab[1][2]==simb[1]:
        tab[1][0]=simb[1]
    elif tab[2][2] == " " and tab[2][0]==tab[2][1]==simb[1]:
        tab[2][2]=simb[1]
    elif tab[2][1] == " " and tab[2][0]==tab[2][2]==simb[1]:
        tab[2][1]=simb[1]
    elif tab[2][0] == " " and tab[2][1]==tab[2][2]==simb[1]:
        tab[2][0]=simb[1]
    elif tab[0][0] == " " and tab[1][0]==tab[2][0]==simb[1]:
        tab[0][0]=simb[1]
    elif tab[1][0] == " " and tab[0][0]==tab[2][0]==simb[1]:
        tab[1][0]=simb[1]
    elif tab[2][0] == " " and tab[0][0]==tab[1][0]==simb[1]:
        tab[2][0]=simb[1]
    elif tab[0][1] == " " and tab[1][1]==tab[2][1]==simb[1]:
        tab[0][1]=simb[1]
    elif tab[1][1] == " " and tab[0][1]==tab[2][1]==simb[1]:
        tab[1][1]=simb[1]
    elif tab[2][1] == " " and tab[0][1]==tab[1][1]==simb[1]:
        tab[2][1]=simb[1]
    elif tab[0][2] == " " and tab[1][2]==tab[2][2]==simb[1]:
        tab[0][2]=simb[1]
    elif tab[1][2] == " " and tab[0][2]==tab[2][2]==simb[1]:
        tab[1][2]=simb[1]
    elif tab[2][2] == " " and tab[0][2]==tab[1][2]==simb[1]:
        tab[2][2]=simb[1]
    elif tab[0][0] == " " and tab[1][1]==tab[2][2]==simb[1]:
        tab[0][0]=simb[1]
    elif tab[1][1] == " " and tab[0][0]==tab[2][2]==simb[1]:
        tab[1][1]=simb[1]
    elif tab[2][2] == " " and tab[1][1]==tab[0][0]==simb[1]:
        tab[2][2]=simb[1]
    elif tab[0][2] == " " and tab[1][1]==tab[2][0]==simb[1]:
        tab[0][2]=simb[1]
    elif tab[1][1] == " " and tab[0][2]==tab[2][0]==simb[1]:
        tab[1][1]=simb[1]
    elif tab[2][0] == " " and tab[1][1]==tab[0][2]==simb[1]:
        tab[2][0]=simb[1]
    else:
        lin = random.randint(0,2)
        col = random.randint(0,2)
