...
def validaJogada_H (nome,i,j):
    while (jhv!='00' or jhv!='01' or jhv!='02' or jhv!='10' or jhv!='11' or jhv!='12' or jhv!='20' or jhv!='21' or jhv!='22'):
        jhv = str(input('Qual sua jogada, '+nome+'? '))
    return jh
