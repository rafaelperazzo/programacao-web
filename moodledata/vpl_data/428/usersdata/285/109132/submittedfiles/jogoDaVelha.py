...
while True:
    if cont4 == 0:
        nome = str(input("\nDigite o seu nome: ")) #O nome será digitado apenas uma vez. No entanto, se o usuário ler as regras, terá outra chance de digitá-lo
    if (nome != "?"): #Se digitar outro nome, ao invés de ler as regras, inicia-se o jogo
        cont4 = 1
        global jog_val_hum, jog_val_comp, jog_poss, jog_poss_win    #Define as quatro listas abaixo como globais
        ...
        jog_poss = ((0,0),(0,1),(0,2),(1,0),(1,1),(1,2),(2,0),(2,1),(2,2)) #Lista que irá guardar as casas possíveis para se jogar
        jog_poss_win = (((0,0),(0,1),(0,2)),((1,0),(1,1),(1,2)),((2,0),(2,1),(2,2)),((0,0),(1,0),(2,0)), #Lista que irá guardar as combinações de vitória possíveis
                        ((0,1),(1,1),(2,1)),((0,2),(1,2),(2,2)),((0,0),(1,1),(2,2)),((2,0),(1,1),(0,2))) 
        cont2 = 0
        Juiz = Coord()                               #Cria o objeto 'Juiz' da classe Coord, que irá "coordenar" as ações dos jogadores
        Tab = Tabuleiro()                            #Cria o objeto 'Tab' da classe Tabuleiro, que irá exibir as jogadas na tela
        Juiz.solicitaSimboloDoHumano()
        Juiz.solicitaLevel()
        clear(1)
        Player = Humano(nome, Juiz.simb_hum)        #Após a solicitação de símbolo e level, é criado então o objeto Player, que será o jogador Humano
        Comp = Computador(Player.simb, Juiz.level)  #É também criado o objeto Comp, que será o jogador Computador
        Juiz.sorteioPrimeiraJogada(Player.nome, Comp.nome, Juiz.level)
        print("\nO(a) primeiro(a) jogador(a) sera o(a) %s!\n"%Juiz.primeiro)
        if (Juiz.primeiro == Player.nome): #Este bloco 'if' é para caso o primeiro jogador seja o Humano
            while True: #O bloco se repetirá até que a função 'verificaVencedor' detecte algum vencendor ou velha
        ...
        else: #Este bloco é para caso o primeiro jogador seja o Computador
            while True:
                Comp.jogadaComputador(Comp.level)
                Juiz.validaJogadaComp(Comp.par_cel)
                Tab.mostraTabuleiro(Player.simb, Comp.simb, "Computador", Juiz.par_cel_comp)
        ...
        cont = str(input("Deseja continuar?: ")) #Se o usuário quiser continuar sem precisar abrir novamente o programa, basta que digite 'sim'
        while True: #Este bloco é apenas para que o programa não seja chato com o usuário, permitindo-lhe digitar desde 's' até 'SIM'
            if (cont == 's' or cont == 'S' or cont == 'sim' or cont == 'Sim' or cont == 'sIm' or
                cont == 'siM' or cont == 'SIm' or cont == 'sIM' or cont == 'SiM' or cont == 'SIM'):
                break
            
            if (cont == 'n' or cont == 'N' or cont == 'nao' or cont == 'Nao' or cont == 'nAo' or
                cont == 'naO' or cont == 'NAo' or cont == 'nAO' or cont == 'NaO' or cont == 'NAO'):
                break
    ...
    else: #Este bloco é para caso o usuário solicite o manual de regras
        """
        instrucoes = open("instrucoes.txt","r") #O módulo 'open' permite abrir arquivos externos. Nesse caso, na opção 'read'
        print(instrucoes.read()) #Essa função lê todo o conteúdo dentro do arquivo, e então o 'print' o exibe para o usuário
        instrucoes.close() #Fecha o arquivo
        """
        clear(1)
        print("----------------------------------------------------------------------")
        ...
        print("----------------------------------------------------------------------")
        print("\n")
        print("Nosso jogo conta com 4 níveis de dificuldade: Fácil, Médio, Difícil e Profissional.")
        print("Experimente jogar cada um deles e sinta a dificuldade em vencer a nossa inteligência artificial (básica)")
        print("aumentando até chegar ao ponto em que ela nunca irá perder, haha!")
        print("\n")
        print("O nosso jogo conta com um sistema de comandos que se assemelha a uma matriz 3x3, sendo que")
        print("ao invés de cada célula ser da forma Aij, com 1 <= i <= 3 e 1 <= j <=3, elas se apresentam")
        print("na forma Amn, com 0 <= m <= 2 e 0 <= n <= 2. Isso significa que as casas do tabuleiro estão")
        print("na seguinte forma:")
        print("\n")
        print("00|01|02")
        print("10|11|12")
        print("20|21|22")
        print("\n")
        print("e para acessar a casa que você deseja preencher, é necessário entrar com o comando do par")
        print("numérico que a representa, sem vírgulas ou parênteses (espaços são permitidos), como no exemplo abaixo:")
        print("\n")
        print("Digite a sua jogada, Humano: 11")
        print("\n")
        print(" | | ")
        print(" |X| ")
        print(" | | ")
        print("\n")
        print("O| | ")
        print(" |X|    (Jogada do computador: 00)")
        print(" | | ")
        print("\n")
        print("Digite a sua jogada, Humano: 0 2")
        print("\n")
        print("O| |X")
        print(" |X| ")
        print(" | | ")
        ...
        print("\n")
        print("Estas são as informações mais relevantes. Descubra todo o resto na prática! Boa sorte!")
        input("\nDigite Enter para continuar...") #Essa linha pausa a execução até que alguma tecla seja ativada. Serve para que o usuário possa ler as regras
        clear(2)
