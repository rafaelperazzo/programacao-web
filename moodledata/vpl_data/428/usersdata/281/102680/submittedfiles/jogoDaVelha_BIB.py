...
def jogadapc ():
    ...
    if simb=='X':
        if sort_pcL==0 and sort_pcC==0:
            l0[0]='O'
        if sort_pcL==0 and sort_pcC==1:
            l0[1]='O'
        if sort_pcL==0 and sort_pcC==2:
            l0[2]='O'
        if sort_pcL==1 and sort_pcC==0:
            l1[0]='O'
        if sort_pcL==1 and sort_pcC==1:
            l1[1]='O'
        if sort_pcL==1 and sort_pcC==2:
            l1[2]='O'
        if sort_pcL==2 and sort_pcC==0:
            l2[0]='O'
        if sort_pcL==2 and sort_pcC==1:
            l2[1]='O'
        if sort_pcL==2 and sort_pcC==2:
            l2[2]='O'
    tab.append(l0)
    tab.append(l1)
    tab.append(l2)
