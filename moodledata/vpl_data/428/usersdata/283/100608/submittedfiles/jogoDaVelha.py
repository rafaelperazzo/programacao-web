...
import time
from jogoDaVelha_BIB import jogada1user
from jogoDaVelha_BIB import jogada1pc
...
if inicio=='Usuário':
    ...
    for i in range(9):
        ...
        print(jogada1user(nome1,tabuleiro,jogada,s1))
elif inicio=='Máquina':
    print('Então eu começo')
    for i in range(9):
        jogada=str(input('Qual a sua jogada '+nome1+'?'))
        print(jogada1pc(nome1,tabuleiro,jogada,s1))
