    ...
    for j in range(0,matriz.shape[1],1):
        ...
        for i in range(0,matriz.shape[0],1):
            ...
            if somaDP==somaColuna:
                ...
                colunaErro==contador
    return('%.d'%(colunaErro-1))

def testeErro(matriz):
    somaDP=somaDiagonalPrincipal(matriz)
    linhaErro=somaLinha(matriz)
    colunaErro=somaColuna(matriz)
    matriz[linhaErro,colunaErro]=0
    n=matriz[linhaErro,colunaErro]
    for i in range(0,matriz.shape[0],1):
        somaDaLinha=0
        for j in range(0,matriz.shape[1],1):
                for i in range(n,100,1):
                    somaDaLinha=somaDaLinha+matriz[i,j]
                if somaDaLinha==somaDP:
                    return(matriz[linhaErro,ColunaErro])
...
ErroNaColuna=somaColuna(matriz)
ErroNaLinha=somaLinha(matriz)
substituto=matriz[ErroNaLinha,ErroNaColuna]
original=testeErro(matriz)
print(original)
print(substituto)
