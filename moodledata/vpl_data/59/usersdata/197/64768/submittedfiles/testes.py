...
print('Ola caro usuario o programa abaixo foi desenvolvido para testar se um número por vc determinado, é ou nâo um numero Vampiro:')
print('********************************************************************************')
print(':)')
n=int(input('Digite um numero de 4 dígitios:'))
