...
print('Ola caro usuario o programa abaixo foi desenvolvido para testar se um número por vc determinado, é ou nâo um numero Vampiro parra isso nessecitamos que seja digitado:')
