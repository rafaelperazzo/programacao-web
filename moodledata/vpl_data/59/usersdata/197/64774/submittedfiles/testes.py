...
print('Ola caro usuario o programa abaixo foi desenvolvido para testar se um número por você determinado, é ou nâo um número Vampiro:')
print('********************************************************************************')
n=int(input('Por favor, digite um numero de 4 dígitios:'))
...
#Usaremos uma segunda repetição, para pedir um novo número, caso o usuário tenha fornecido anteriormente um numero diferente de 4 dígitos 
while cont!=4:
    cont=0
    lista=[]
