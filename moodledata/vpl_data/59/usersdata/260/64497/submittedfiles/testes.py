...
#A diferença do fator de atrito atualizado com o seu anterior irá gerar um erro e se este for sufucientemente pequeno o programa irá se encerrar,caso contrário o mesmo irá se repetir.
    Erro=FT-A
#Como os valores de dessa diferença podem flutuar entre números positivos e negativos, então é essencial que para o Erro seja estabelecido em módulo a fim de que o a condição essencial seja satisfeita e o valor obtido seja confiável.
    if Erro<0:
        Erro=Erro*(-1)
