...
L=float(input("Digite o valor do comprimento da tubuação em metros:"))
...
#Depois, estimamos um erro incial maior que o exigido em sua definição para possibilitar que o programa execute o que lhe é exigido.
Erro=1
...
#Por fim, a partir do número de Reynolds, o programa irá  classificar o escoamento como laminar ou turbulento através de uma comparação com o valor 2000.
if REY<=2000:
