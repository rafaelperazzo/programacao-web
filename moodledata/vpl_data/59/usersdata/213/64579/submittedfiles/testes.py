...
print('Razão Áurea é representada pela letra grega phi, e fascina pessoas desde a antiguidade, pois aparece de maneira espontânea na natureza. É as relações áureas entre as medidas são chamadas de número de ouro.\n')
print('Calculamos a razão áurea através de um método de aproximação bem precisa a fim de encontrar valores próximos a 1.6281... Neste programa iremos lhe ajudar a encontrar um valor mais exato através de uma fórmula.\n')
...
valorCosseno=calcula_co_seno(z,epsilon)#Chama a função para calcular o valor do Cosseno, formando o valor de Z e o valor mínimo dos termos
