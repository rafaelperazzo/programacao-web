...
print('Razão Áurea é representada pela letra grega phi, e fascina pessoas desde a antiguidade, pois aparece de maneira espontânea na natureza. É as relações áureas entre as medidas são chamadas "de ouro".\n')
