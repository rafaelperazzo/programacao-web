...
h=float(input('Agora gostaríamos de saber sua altura:) :'))
#Com os valores recebidos calculamos o seu IMC e peso ideal
imc= p/(h*h)
pi=(72.7*h)-58
#A partir dos cálculos, indicamos qual a situação do usuário e forncemos, um breve aconselhamento nutricional
if imc<= 18.4:
