...
def algarismo(n): #Recebe valor do usuário, faz sucessivas divisões por 10, para separar os termos e adicionar a uma lista.
    a=[]
    while(n!=0) :
        a.append(n%10)
        n=n//10
...
def soma2(a): #Recebe a lista e soma o quadrado dos termos.
    soma=0
...
while n//10!=0: #Executa as funções enquanto o n for diferente de 0.
    b=algarismo(n)
    n=soma2(b)
if n==1: #Compara se o n é igual a 1 (para mostrar que é Feliz)
    print('Feliz')
if n!=1: #Compara se o n é diferente de 1
    print('Não Feliz')
