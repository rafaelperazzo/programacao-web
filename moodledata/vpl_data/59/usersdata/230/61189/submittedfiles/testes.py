...
#Nesta primeira função, enquanto o valor de 'n' for diferente de 0 será dividido por 10, para ter os termos 
#separados e assim adicionados na lista. 
#A lista receberá o resto da divisão inteira por 10. E por fim retornará a lista 'a'.
def algarismo(n):
    a=[]
    while(n!=0) :
        a.append(n%10)
...
#'b' receberá a função 'algarismo' que será parâmetro da função 'soma2'. E por fim 'n' receberá esta soma de 'b'. E quando o n chegar 
