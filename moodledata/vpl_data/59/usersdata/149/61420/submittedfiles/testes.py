# -*- coding: utf-8 -*-
import itertools 
#número vampiro é um número onde a multiplicação de todas as combinações possiveis -(os dois termos primeiro com os dois ultimos dê pelo menos
...
#iniciei o contador para ver se há pelo menos UMA combinação onde a multiplicação dos 2 termos primeiros vezes os dois ultimos dê o número inicial...
