...
assim, o número é substituido pela soma dos quadrados dos seus dígitos e repete-se o processo até que o número seja igual a 1 ou até que entre num ciclo infinito.''')
print('******************************************************************************')
...
n = int(input('Digite um número ao qual você deseja testar se é ou não feliz:'))
x=n
...
while i != 0:
    ...
    #O INCREMENTO DA LISTA SERÁ FEITO PARA NÃO PERDERMOS OS NÚMEROS ANTERIORMENTE CALCULADOS PARA PODEMOS TESTAR SE HAVERÁ REPETIÇÃO OU NÃO.
    ...
    #CASO HAJA, O NÚMERO NÃO SERÁ FELIZ.
        ...
        print ('%.d Não é um número feliz' %x)
        break
