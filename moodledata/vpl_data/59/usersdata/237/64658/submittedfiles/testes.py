...
while 0!=1: # Aqui inicia o looping que realizará a operação da função 'feliz' o número de vezes que for necessário (nota-se que a repetição é infinita e para somente se 'n' for identificado com feliz ou não
    ...
    if o==1:
      ...
      n=0+o  #Case ele aina nao seja identificado como nenhuma das atribuições, avarialvel 'n' é atualizada para um novo número (gerado pela função feliz), esse número será, a partir de agora, ultilizado nas operações