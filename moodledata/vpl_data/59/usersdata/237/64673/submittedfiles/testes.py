# -*- coding: utf-8 -*-
while 0!=1: # o programa se repete quantas vezes o usuario desejar
    ...
    while 0!=1: # Aqui inicia o looping que realizará a operação da função 'feliz' o número de vezes que for necessário (nota-se que a repetição é infinita e para somente se 'n' for identificado com Feliz ou Não Feliz) 
        ...
        if o==1:
            ...
            break
        elif (o==89) or n==0: # Caso o número seja identificado como Não Feliz, a repetição para e a frase é exibida na tela
            print("Não Feliz")
            break
        else:
