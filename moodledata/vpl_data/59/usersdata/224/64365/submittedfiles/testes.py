...
fixo. Além disso, é necessário criar uma repetição para calcular o valor do termo que tem o parâmetro m como critério de parada. O termo apre-
senta o numerador como número fixo quatro 
