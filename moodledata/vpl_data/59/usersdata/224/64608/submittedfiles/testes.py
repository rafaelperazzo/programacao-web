...
def razaoaurea (m, epsilon):
    ...
    return (razao)
'''Para obter a aproximação de PHI é necessária chamar a função cosseno, por isso a "razaoaurea" recebe dois parâmetros, um para o calculo 
aproximado de pi, definido na primeira função e o outro que será utilizado como critério de parada do termo na função cosseno.'''
