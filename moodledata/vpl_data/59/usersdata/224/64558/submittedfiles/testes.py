...
def pi (m):
    ...
    for termo in range (1, m+1, 1):
        ...
        z = z + 2
    return (soma)
'''Criamos uma função para calcular o valor de Pi, a qual receberá um parâmetro (m). A série inicia-se com um somátorio com três como valor
...
Quando o termo for par, soma o seu valor do somatório. Caso contrário, subtrai. O numerador do termo é um parâmetro cujo expoente é uma 
...
é a variável v que representa a possição do termo no somatório.'''
