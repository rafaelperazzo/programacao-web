...
#na lista2.Por fim se cont=1 ele vai pegar e inserir o valor de k no resultado
#em seguida ele irar imprimir os elementos que estão no resultado, ou seja, os
#numeros vampiros.