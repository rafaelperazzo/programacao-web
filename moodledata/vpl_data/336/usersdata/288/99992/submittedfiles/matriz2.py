...
for i in range (0,dim,1):
    for j in range (0,dim,1):
        matriz[i][j]=float(input("Digite um numero: "))
...
for i in range (0,dim,1):
    for j in range (0,dim,1):
        matrizultprim=matriz[i][dim-1-j]
        
for i in range (0,dim,1):
    matrizdiag[2][i]=matriz[i][i]
for i in range (0,dim,1):
    matrizdiag[2][i]=matrizultprim[i][i]
