...
diferentelinha = diferentelinha (matriz)
indicelinha = index.diferentelinha
diferentecoluna = diferentecoluna (matriz)
indicecoluna = index.diferentecoluna
