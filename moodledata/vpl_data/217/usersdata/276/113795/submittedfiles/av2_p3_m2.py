...
indicelinha = diferente (a)
diferentelinha = a[indicelinha]
print (diferentelinha)
print (indicelinha)
indicecoluna = diferente (b)
diferentecoluna = b[indicecoluna]
...
resposta = matriz [indicelinha,indicecoluna] - subtracao1

print (matriz [indicelinha,indicecoluna]- 2)
print (resposta + 10)
