...
if u==a or u==b or u==c or u==d or u==e or u==f:
    cont=cont+1
elif v==a or v==b or v==c or v==d or v==e or v==f:
    cont=cont+1
elif w==a or w==b or w==c or w==d or w==e or w==f:
    cont=cont+1
elif x==a or x==b or x==c or x==d or x==e or x==f:
    cont=cont+1
elif y==a or y==b or y==c or y==d or y==e or y==f:
    cont=cont+1
elif z==a or z==b or z==c or z==d or z==e or z==f:
    cont=cont+1
print(cont)    