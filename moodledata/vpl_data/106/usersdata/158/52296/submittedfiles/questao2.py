...
if v6==y1 and v4==y2 and v3==y3 and v4!=y4 and v5!=y5 and v6!=y6:
    print('terno')
elif v6!=y1 and v1!=y2 and v2!=y3 and v3==y5 and v4==y4 and v5==y6:
    print('sena')
elif v1!=y1 and v2!=y2 and v3==y3 and v4==y4 and v5==y5 and v6==y6:
    print('quadra')
elif v1!=y1 and v2==y2 and v3==y3 and v4==y4 and v5==y5 and v6==y6:
    print('quina')
elif v1!=y1 and v2!=y2 and v3!=y3 and v4!=y4 and v5!=y5 and v6!=y6:
