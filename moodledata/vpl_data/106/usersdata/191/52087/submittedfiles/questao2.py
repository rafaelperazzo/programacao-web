...
if (ap1==s1 or ap1==s2 or ap1==s3 or ap1==s4 or ap1==s5 or ap1==s6):
    cont=cont+1
elif (ap2==s1 or ap2==s2 or ap2==s3 or ap2==s4 or ap2=s5 or ap2==s6):
    cont=cont+1
elif (ap3==s1 or ap3==s2 or ap3==s3 or ap3==s4 or ap3==s5 or ap3==s6):
    cont=cont+1
elif (ap4==s1 or ap4==s2 or ap4==s3 or ap4==s4 or ap4==s5 or ap4==s6):
    cont=cont+1
elif (ap5==s1 or ap5==s2 or ap5==s3 or ap5==s4 or ap5==s5 or ap5==s6):
    cont=cont+a1
elif (ap6==s1 or ap6==s2 or ap6==s3 or ap6==s4 or ap6==s5 or ap6==s6):
    cont=cont+1
if cont==3:
    print(terno)
if cont==4:
