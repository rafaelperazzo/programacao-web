...
if (crescente(a)):
    print('S')
elif (not crescente(a)):
    print('N')

if (decrescente(a)):
    print('S')
elif (not decrescente(a)):
    print('N')

if (consecutivo_igual(a)):
    print('S')
elif (not consecutivo_igual(a)):
    print('N')

if (crescente(b)):
    print('S')
elif (not crescente(b)):
    print('N')

if (decrescente(b)):
    print('S')
elif (not decrescente(b)):
    print('N')

if (consecutivo_igual(b)):
    print('S')
elif (not consecutivo_igual(b)):
    print('N')

if (crescente(c)):
    print('S')
elif (not crescente(c)):
    print('N')

if (decrescente(c)):
    print('S')
elif (not decrescente(c)):
    print('N')

if (consecutivo_igual(c)):
    print('S')
elif (not consecutivo_igual(c)):
    print('N')
