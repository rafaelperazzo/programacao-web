...
#COMPARAR O NÚMERO DE IGUALDADES A QUANTIDADE DE LINHAS -1
...
#É ATRIBUIDO UM VALOR A SOMA DIFERENTE DO VALOR DA SOMA DAS LINHAS



#PARA A DIAGONAL PRINCIPAL FORAM SOMADOS APENAS OS VALORES COM COORDENADAS IGUAIS
    somaD1=0
