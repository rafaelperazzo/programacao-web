...
def ganhou(simbolo, tabuleiro):
    ...
    if tabuleiro[0][0] == simbolo and tabuleiro[1][0] == simbolo and tabuleiro[2][0] == simbolo:
        return 1
    if tabuleiro[0][1] == simbolo and tabuleiro[1][1] == simbolo and tabuleiro[2][1] == simbolo:
        return 1
    if tabuleiro[0][2] == simbolo and tabuleiro[1][2] == simbolo and tabuleiro[2][2] == simbolo:
        return 1
