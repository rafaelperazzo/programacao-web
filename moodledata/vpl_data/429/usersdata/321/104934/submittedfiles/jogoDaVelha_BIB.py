...
def ganhou(simbolo, campo):
    if campo[0][0] == simbolo and campo[0][1] == simbolo and campo[0][2] == simbolo:
        return 1
    if campo[1][0] == simbolo and campo[1][1] == simbolo and campo[1][2] == simbolo:
        return 1
    if campo[2][0] == simbolo and campo[2][1] == simbolo and campo[2][2] == simbolo:
        return 1
    if campo[0][0] == simbolo and campo[1][0] == simbolo and campo[2][0] == simbolo:
        return 1
    if campo[0][1] == simbolo and campo[1][1] == simbolo and campo[2][1] == simbolo:
        return 1
    if campo[0][2] == simbolo and campo[1][2] == simbolo and campo[2][2] == simbolo:
        return 1
    if campo[0][0] == simbolo and campo[1][1] == simbolo and campo[2][2] == simbolo:
        return 1
    if campo[0][2] == simbolo and campo[1][1] == simbolo and campo[2][0] == simbolo:
        return 1
