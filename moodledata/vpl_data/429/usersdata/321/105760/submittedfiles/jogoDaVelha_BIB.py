...
def sorteioPrimeiraJogada(nome,sort):
    j1 = nome
    j2 = 'Computador'
    sort = random.randint(0,1)
    if sort == 1:
        return sort,print ('Vencedor do sorteio para início do jogo: %s' % j1)
    if sort == 0:
        return sort,print ('Vencedor do sorteio para início do jogo: %s' % j2)
