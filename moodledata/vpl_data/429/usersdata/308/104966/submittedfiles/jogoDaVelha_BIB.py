...
#jogadasValidas = ['1 2', '2 2', '2 1', '0 2', '2 0', '0 1', '1 0', '1 1', '0 0']
jogadasValidas = ['0 0', '0 1', '0 2', '1 0', '1 1', '1 2', '2 0', '2 1', '2 2']
def verificaVencedor(tabela): #Verifica se há vencedor || Parâmetro: Recebe a tabela para verificar || Retorno: Retorna o simbolo do vencedor
    for a in range(0, 3):
        mostraTabuleiro(tabela)
        print('- - - - - - - - - - -  -- - - - ')
        if (tabela[0][a]==tabela[1][a]==tabela[2][a]) and not(tabela[1][a]==' '):
            return tabela[1][a]
        elif (tabela[a][0]==tabela[a][1]==tabela[a][2]) and not(tabela[a][1]==' '):
            return tabela[a][1]
    if ((tabela[0][0]==tabela[1][1]==tabela[2][2])and not(tabela[1][1]==' ')) or ((tabela[2][0]==tabela[1][1]==tabela[0][2])and not(tabela[a][1]==' ')):
        return tabela[1][1]
    return ' '
