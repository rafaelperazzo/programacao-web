...
while jgnov == 'S' or jgnov =='s':
    print('Bem vindo ao JogoDaVelha do grupo D [Anderson Bezerra, Caio César, Juan, Laura Nunes]')
    ...
    while True:
        if jogador == 1:
            ...
            jogador = 1
    print('Caso queira jogar novamente digite: S ou s')
    jgnov = input('\nQuer jogar denovo (S ou s)? ')
