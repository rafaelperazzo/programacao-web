...
import time
#senha para jogar
print('Para rodar este programa você precisa da senha')
c=int(input('Digite a senha:'))
z = c*1
while z!= 01234567899876543210:
    print('Ops, senha incorreta, tente novamente...')
    c=int(input('Digite a senha:'))
    break
#Simbolo que o Jogador quer utilizar
def solicitaSimbolodoHumano(a):
    a = input('\nQual símbolo você deseja utilizar no jogo (X/x ou O/o)? ')
