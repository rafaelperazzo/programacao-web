...
if (x1==x4==x7)==1 or (x1==x2==x3)==1 or (x2==x5==x8)==1 or (x3==x6==x9)==1 or (x4==x5==x6)==1 or (x7==x8==x9)==1:
    print('1')
if (x1==x4==x7)==0 or (x1==x2==x3)==0 or (x2==x5==x8)==0 or (x3==x6==x9)==0 or (x4==x5==x6)==0 or (x7==x8==x9)==0:
    print('0')
else:
    print('E')
