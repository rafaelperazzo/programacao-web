...
if x3==x5 and x5==x7:
    print(x7)
if x1==x2 and x2==x3 or x4==x5 and x==x6 or x7==x8 and x8==x9 or x1==x4 and x4==x7 or x2==x5 and x5==x8 or x3==x6 and x6==x9 or x1==x5 and x5==x9 or x3==x5 and x5==x7
    print()
else:
    print('E')