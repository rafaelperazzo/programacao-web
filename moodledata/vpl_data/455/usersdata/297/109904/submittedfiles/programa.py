...
for i in range(n):
    ...
    matriz.append(linha)
soma_linha=0           #soma_correta_de_linhas
soma_col=0             #soma_correta_de_colunas
...
for j in range(0,3,1):
    list_sum_col=[]            #lista_com_os_valores_da_soma_de_cada_coluna
    soma_coluna=0
...
for j in range(0,n,1):
    ...
    if soma_col!=sum_col:
        ...
        erro2=j
        break
certo=erro_linha-erro1
certo_vrd=soma_linha-certo
print(matriz[erro1][erro2])
print(certo_vrd)