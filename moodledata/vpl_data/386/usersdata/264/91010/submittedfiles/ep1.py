...
cont=0
while (cont<n):
    a = floa(input('digite  valor de a: '))
    b = floa(input('digite  valor de b: '))
    c = floa(input('digite  valor de c: '))
    if (a==0):
        print(a)
        print(b)
        print(c)
    ...
    if (a!=0):
        ...
        id (delta<0):
            ...
            print('A equação tem como raízes %.5f + ( %.5ff *i )' %(X1,complexo_1)
            print('A equação tem como raízes %.5f + ( %.5ff *i )' %(X2,complexo_2)