...
/* Número de matrículas: 407549 e 405947                   */
...
while cont<n:
    ...
    if a==0:
        ...
        if delta>0:
            ...
            print('%.2f    %.2f    %.2f     complexas    %.4f + i*%.4f     %.4f - i*%.4f' %(a,b,c,x1,raiz_delta,x2,raiz_delta))
        else:
            x1=-b/(2*a)
            x2=x1
            print('%.2f    %.2f    %.2f      real dupla    %.4f               %.4f' %(a,b,c,x1,x2))
