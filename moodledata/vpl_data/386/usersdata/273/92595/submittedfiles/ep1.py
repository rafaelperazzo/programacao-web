...
'''DEFININDO A FUNÇAO PARA CALCULAR O VALOR DO DELTA'''
def delta(a,b,c):
    delta=(b**2)-(4*a*c)
    return(delta)

'''DEFININDO A FUNÇAO PARA CALCULAR O VALOR DAS RAIZES ,USANDO O METODO DE BASKARA'''
def baskara (a,b,c,delta):
    if (delta==0):
        ...
        return('complexas'),(complex('%.5f'%real,'%.5f'%complexa1)),(complex('%.5f'%real,'%.5f'%complexa2))

'''APOS AS FUNOES ESTAREM DEFINIDAS PEDIREMOS OS DADOS DE ENTRADA'''
