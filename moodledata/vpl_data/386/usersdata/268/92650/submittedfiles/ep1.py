...
#ENTRADA DOS VALORES INICIAIS - EPSILON E NUMERO DE EQUAÇÔES
    ...
    if (a!=0):
        ...
        if (Delta>0):
             ...
             if (X1!=X2):
                 ...
                 print('A equação tem como raíz %.5f'%X1)
                 print('A equação tem como raíz %.5f'%X2)
        ...
        if (Delta<0):
            ...
            print('A equação tem como raíz %.5f + ( %.5f *i )' %(X1,Complexo_1))
            print('A equação tem como raíz %.5f + ( %.5f *i )' %(X2,Complexo_2))
