...
if person(lista,prova)>=0.9:
    print('Muito Forte')
if 0.7<=person(lista,prova)<0.9 or -0.9<person(lista,prova)<=-0.7:
    print('Forte')
if 0.5<=person(lista,prova)<0.7 or -0.7<person(lista,prova)<=-0.5:
    print('Moderada')
if 0.3<=person(lista,prova)<0.5 or -0.5<person(lista,prova)<=-0.3:
    print('Fraca')
if 0<=person(lista,prova)<0.3 or -0.3<person(lista,prova)<=0:
    print('Desprezível')
