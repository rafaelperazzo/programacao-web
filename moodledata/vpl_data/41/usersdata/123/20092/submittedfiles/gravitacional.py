...
matrizA = input('Digite a Matriz T como uma única linha entre aspas 0 10 15 12 13 0 23 14 31 43 0 11 19 32 18 0: ')
...
#INÍCIO
#EU
a= funcoes.somLinhas(A)
o= funcoes.somColunas(A)
