...
def razaoaurea(m,epsilon):
    fi=(2*(cos(numpi(m)/5),epsilon))
    
m=int(input('Digite o número de termos m da fórmuls de pi: '))
epsilon=int(float(input('Digite o epsilon para o cálculo da razão aurea: '))
