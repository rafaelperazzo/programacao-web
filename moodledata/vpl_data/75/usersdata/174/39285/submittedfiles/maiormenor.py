...
if a>b and a>c and a>d and a>e and b>c and b>d and b>e:
    print ('%f'%a)
    print ('%f'%b)
elif a>b and a>c and a>d amd a>e and c>b and c>d and c>e:
    print ('%f'%a)
    print ('%f'%c)
elif a>b and a>c and a>d amd a>e and d>b and d>c and d>e:
    print ('%f'%a)
    print ('%f'%d)
elif a>b and a>c and a>d amd a>e and e>b and e>c and e>d:
    print ('%f'%a)
    print ('%f'%e)
