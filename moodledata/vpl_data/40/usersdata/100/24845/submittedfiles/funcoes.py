# -*- coding: utf-8 -*-
"""
Created on Sat Dec 03 11:30:50 2016

@author: Bil
"""
from __future__ import division
""" O trabalho consiste em calcular a razão áurea por meio do número de termos de π e por um valor para epsilon (ε) """

def  calcula_valor_absoluto(x):
#Sempre que o valor atribuido a variável x for menor que zero se faz necessário usá-lo em módulo para isso faremos:
    if x<0:
        a = x*(-1)
        return a
    else:
...
def calcula_pi(m):
     ...
     cont = 1
     soma= 0
# Quando o contador , iniciado em 1, for par a parte da função que calcula pi será multiplicada por -1, assim, consiguremos alternar os sinais na operação.
...
"""def calcula_co_so(z,epsilon): 
    ...
    while True:
        ...
        cont=cont+1
    return cosseno"""
"""Função para calculcar a razão áurea"""
def calcula_co_so(z,epsilon):
    ...
    while True:
        p = 1
        #calcular o fatorial dentro da repetição
        for i in range (1,n+1,1):
            p =p*i
...
#abaixo seguem as atualizações e suas devidas explicações:
        n = n+2
#Tanto as potências como os fatoriais tem inicio no valor 2 e aumentam ao passo  = 2, logo para cada atualização o valor de n aumenta duas unidades.
        cont  = cont +1
