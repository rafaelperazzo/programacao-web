...
#(conforme a fórmula "3" do Enunciado do Programa), para o cálculo do cosseno (conforme a expressão "2" do Enunciado do Programa)
...
#Na função "calcula_co_seno(z, epsilon)", calcula-se o cosseno - a sentença "termo" cita cada termo (com exeção do número 1) assim como consta na expressão "2".
#Enquanto o termo for maior que o epsilon que o usuário entrou, decorre a seguinte condição - para o índice "i" -
#se o índice for ímpar o termo é negativo, se for par é positivo, conforme os índices e termos da expressão "2" do enunciado.
#Enquanto isso, o cont (que é expoente e número fatorial, além de pertencer a um padrão periódico na fórmula) atualiza (+2),
#bem como o índice (nesse caso, "+1"), para assim continuar a repetição.
#No final, o cosseno é igual ao valor acumulado no resultado + 1.
