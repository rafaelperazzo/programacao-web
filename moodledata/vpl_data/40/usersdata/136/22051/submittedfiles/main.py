...
#não utilizar um código que trabalhasse uma determinada variável e ao final somasse com "1". Então a ideia deste código que escrevi,
#foi utilizar dos índices (a começar pelo 0) com (x^0)/0! que é igual a 1...
