...
n4 = int(input('digite x a quarta: '))
n3 = int(input('digite x ao cubo: '))
n2 = int(input('digite x ao quadrado: '))
n1 = int(input('digite x : '))
n0 = int(input('digite constante: '))
