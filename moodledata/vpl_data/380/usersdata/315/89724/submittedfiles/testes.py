...
for i in range(99999):
    x = random.choice(('a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'))
    print ('%d' +'%d'+'%d'+'%d'+'%d'+'%d'+'  +'%d'+'%d'+'%d'  %(x,x,x,x,x,x,x,x,x,x))
    print ('\n _______________________________________________________________________________')
    time.sleep(0.00005)+'%d'  %(x,x,x,x,x,x,x,x,x,x)
