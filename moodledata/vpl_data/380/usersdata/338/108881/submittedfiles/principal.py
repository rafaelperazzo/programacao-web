...
#######################################################################################
def recebe_e_validar_jogada(simb,simbc):
    ...
    while(True): 
        if int(n[0]) >= 0 and int(n[0]) < 3 :
            if int(n[1]) >= 0 and int(n[1]) < 3:
                if tabuleiro[i][j] != simb and tabuleiro[i][j] != simbc :
                    break
        else:
...
jn = 's'
while jn == 's' or jn == 'S' or jn == 'Sim' or jn == 'sim' or jn == 'SIM' or jn == 'si' :
    ...
    simb = input('Digite o simbolo [ X ou O] com o qual você deseja jogar %s : ' % nome_do_jogador)
    ...
    if a == '1':
        ...
        while(True) :
                mostre_tabuleiro()
                recebe_e_validar_jogada(simb,simbc)
                if verifica_vencedor(simb,simbc) == True  :
                    if verifica_vencedor(simb,simbc) == 'Velha' :
                        print(' ')
                        print('Deu velha')    
                        break
                    else:
