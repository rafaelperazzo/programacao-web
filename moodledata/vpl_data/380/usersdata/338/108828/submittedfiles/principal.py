...
def verifica_vencedor():
    if (tabuleiro[0][0]==tabuleiro[0][1]==tabuleiro[0][2]==('X' or 'O')) : 
        print("O jogo terminou")
        return True
    elif (tabuleiro[1][0]==tabuleiro[1][1]==tabuleiro[1][2]==('X' or 'O')) : 
        print("O jogo terminou")
        return True
    elif (tabuleiro[2][0]==tabuleiro[2][1]==tabuleiro[2][2]==('X' or 'O')) :
        print("O jogo terminou")
        return True
    elif (tabuleiro[0][0]==tabuleiro[1][0]==tabuleiro[2][0]==('X' or 'O')) :
        print("O jogo terminou")
        return True
    elif (tabuleiro[0][1]==tabuleiro[1][1]==tabuleiro[2][1]==('X' or 'O')) :
        print("O jogo terminou")
        return True
    elif (tabuleiro[0][2]==tabuleiro[1][2]==tabuleiro[2][2]==('X' or 'O')) :
        print("O jogo terminou")
        return True
    elif (tabuleiro[0][0]==tabuleiro[1][1]==tabuleiro[2][2]==('X' or 'O')) :
        print("O jogo terminou")
        return True
    elif (tabuleiro[0][2]==tabuleiro[1][1]==tabuleiro[2][0]==('X' or 'O')) :
        print("O jogo terminou")
        return True 
