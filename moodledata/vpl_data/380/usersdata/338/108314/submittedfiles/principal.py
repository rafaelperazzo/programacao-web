...
def jogada_do_computador(tabuleiro,simb):
    lista_possib = ['00', '21', '02', '10', '11', '12', '22', '20', '01']
    n = (random.choice([lista_possib]))
    while(True): 
        i = int(n[0])
        j = int(n[1])
        if tabuleiro[i][j] != "X" and tabuleiro[i][j] != "O" : 
...
jogada_do_computador(tabuleiro,simb)       
