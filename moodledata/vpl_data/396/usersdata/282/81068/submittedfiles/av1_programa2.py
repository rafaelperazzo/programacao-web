...
if a//n1 == 1 or a//n2 == 1 or a//n3 == 1 or a//n4 == 1 or a//n5 == 1 or a// n6== 1:
    acerto1 = acerto + 1
        ...
        acerto1 = acerto
        if b//n1 == 1 or b//n2 == 1 or b//n3 == 1 or b//n4 == 1 or b//n5 == 1 or b// n6== 1:
            acerto2 = acerto1 + 1
        else:
            acerto2 = acerto1
            if c//n1 == 1 or c//n2 == 1 or c//n3 == 1 or c//n4 == 1 or c//n5 == 1 or c// n6== 1:
                acerto3 = acerto2 + 1
            else:
                acerto4 = acerto3
                if d//n1 == 1 or d//n2 == 1 or d//n3 == 1 or d//n4 == 1 or d//n5 == 1 or d// n6== 1:
                    acerto4 = acerto3 + 1
                else:
                    acerto5 = acerto4
                    if e//n1 == 1 or e//n2 == 1 or e//n3 == 1 or e//n4 == 1 or e//n5 == 1 or e// n6== 1:
                        acerto5 = acerto4 + 1
                    else:
                        acerto5 = acerto4
                        if f//n1 == 1 or f//n2 == 1 or f//n3 == 1 or f//n4 == 1 or f//n5 == 1 or f// n6== 1:
                            acertofinal = acerto5 + 1
                        else:
                            acertofinal = acerto5
                            if acertofinal<3:
                                print('azar')
