...
#saida
print('%2.f'%investimento1)
print('%2.f'%investimento2)
print('%2.f'%investimento3)
print('%2.f'%investimento4)
print('%2.f'%investimento5)
print('%2.f'%investimento6)
print('%2.f'%investimento7)
print('%2.f'%investimento8)
print('%2.f'%investimento9)
print('%2.f'%investimento10)
