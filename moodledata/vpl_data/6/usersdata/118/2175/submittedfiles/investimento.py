...
#3
print('%.2f R$ no 1° ano'  %invest1)
print('%.2f R$ no 2° ano'  %invest2)
print('%.2f R$ no 3° ano'  %invest3)
print('%.2f R$ no 4° ano'  %invest4)
print('%.2f R$ no 5° ano'  %invest5)
print('%.2f R$ no 6° ano'  %invest6)
print('%.2f R$ no 7° ano'  %invest7)
print('%.2f R$ no 8° ano'  %invest8)
print('%.2f R$ no 9° ano'  %invest9)
print('%.2f R$ no 10° ano'  %invest10)