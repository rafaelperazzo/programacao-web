...
/**
 * Strings for component 'media', language 'pt_br', branch 'MOODLE_31_STABLE'
 *
 * @package   media
...
$string['legacyquicktime_desc'] = 'Arquivos com extensões *.mov, *.mp4, *.m4a e *.mpg. Requerem o reprodutor de QuickTime ou codecs.';
