...
$string['availablesearchareas'] = 'Áreas disponíveis para busca';
...
$string['blockeditingmenu_desc'] = 'Se habilitado, muitos dos ícones de edição de blocos (mostrados quando a edição está ligada) serão exibidos como um menu drop-down. Isso reduz o conteúdo na tela, ocultando os ícones até que eles sejam necessários.';
...
$string['navexpandmycourses'] = 'Mostrar "Meus cursos" expandidos no Painel';
$string['navexpandmycourses_desc'] = 'Se ativado, "Meus cursos" é inicialmente mostrado expandido no bloco de navegação no Painel.';
...
$string['pathtounoconv_help'] = 'Caminho para o conversor de documentos unoconv. Este é um executável que é capaz de converter entre formatos de documentos suportados pelo LibreOffice. Isto é opcional, mas se for especificado, o Moodle vai usá-lo para converter automaticamente entre formatos de documentos. Isto é usado para suportar uma ampla gama de arquivos de entrada para o recurso PDF atribuição de anotações.';
