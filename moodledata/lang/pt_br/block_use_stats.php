...
/**
 * Strings for component 'block_use_stats', language 'pt_br', branch 'MOODLE_31_STABLE'
 *
...
$string['configkeepalivedelay_desc'] = 'Atraso entre dois sinais de log de retenção para usuários conectados (segundos). Mantenha o máximo possível para diminuir a carga do servidor quando muitos usuários estiverem conectados, mantendo as pistas de rastreamento consistentes.';
