...
/**
 * Strings for component 'completion', language 'pt_br', branch 'MOODLE_31_STABLE'
 *
 * @package   completion
...
$string['err_settingslocked'] = 'Um ou mais alunos já cumpriram o critério, por isto a configuração está bloqueada. Desbloquear a configuração dos critérios apagará os dados de usuários e poderá causar confusão.';
