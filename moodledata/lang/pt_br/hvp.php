...
/**
 * Strings for component 'hvp', language 'pt_br', branch 'MOODLE_31_STABLE'
 *
 * @package   hvp
...
$string['author'] = 'Autor';
$string['availableversion'] = 'Atualização disponível';
...
$string['currentversion'] = 'Você está executando';
...
$string['downloadandupdate'] = 'Baixar e Atualizar';
...
$string['externalcommunication'] = 'Comunicação externa';
$string['externalcommunication_help'] = 'Auxílie no desenvolvimento do plugin H5P contribuindo com dados anônimos. A desativação dessa opção irá impedir que seu site busque por atualizações mais recentes. Você pode ler mais sobre <a {$a}>quais informações são coletadas</a> em h5p.org.';
...
$string['hvp:updatesavailable'] = 'Obter notificação quando atualizações H5P estiverem disponíveis';
...
$string['messageprovider:updates'] = 'Notificação de atualizações H5P disponíveis';
...
$string['missingh5purl'] = 'Ausência de URL para arquivo H5P';
...
$string['unabletodownloadh5p'] = 'Incapaz de baixar o arquivo H5P';
...
$string['updatesavailablemsgpt1'] = 'Existem atualizações disponíveis para os tipos de conteúdo H5P que você tem instalado em seu site Moodle.';
$string['updatesavailablemsgpt2'] = 'Passe o mouse sobre a página do link abaixo para obter mais instruções.';
$string['updatesavailablemsgpt3'] = 'A última atualização foi lançada em: {$a}';
$string['updatesavailablemsgpt4'] = 'Você está executando uma versão de: {$a}';
$string['updatesavailabletitle'] = 'Novas atualizações H5P estão disponíveis';
...
$string['usebuttonbelow'] = 'Você pode usar o botão abaixo para baixar e atualizar todos os seus tipos de conteúdo automaticamente.';
$string['user'] = 'Usuário';
$string['welcomeheader'] = 'Bem-vindo ao mundo da H5P!';
$string['whyupdatepart1'] = 'Você pode ler sobre por que é importante para atualizar e os benefícios de fazê-lo na página<a {$a}>Porque atualizar H5P</a>.';
$string['whyupdatepart2'] = 'A página também lista os diferentes changelogs, onde você pode ler sobre as novas funcionalidades introduzidas e os problemas que foram corrigidos.';
$string['year'] = 'Ano';
$string['years'] = 'Ano(s)';
