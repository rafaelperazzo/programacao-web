...
/**
 * Strings for component 'tool_langimport', language 'pt_br', branch 'MOODLE_31_STABLE'
 *
...
$string['remotelangnotavailable'] = 'Moodle não consegue acessar download.moodle.org. Não é possível fazer a atualização automática. Como alternativa, baixe os arquivos zip em <a href="https://download.moodle.org/langpack/">download.moodle.org/langpack</a>, copie-os no diretório {$a} e descompacte-os manualmente.';
