...
/**
 * Strings for component 'tool_lp', language 'pt_br', branch 'MOODLE_31_STABLE'
 *
 * @package   tool_lp
...
$string['nolinkedcourses'] = 'Nenhum curso está vinculado a esta competência';
...
$string['reopenplanconfirm'] = 'Reabrir o plano de aprendizagem \'{$a}\'? Em caso afirmativo, o status das competências dos usuários, que foi gravado no momento em que o plano foi concluído anteriormente, será excluído e o plano ficará ativo novamente.';
...
$string['selectuserstocreateplansfor'] = 'Selecione os usuários para criar planos de aprendizado para';
...
$string['unlinkplantemplateconfirm'] = 'Desvincular o plano de aprendizagem \'{$a}\' do seu modelo? Qualquer alteração feita no modelo não será mais aplicada ao plano. Essa ação não pode ser desfeita.';
