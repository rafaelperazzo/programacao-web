...
/**
 * Strings for component 'folder', language 'pt_br', branch 'MOODLE_31_STABLE'
 *
 * @package   folder
...
$string['showdownloadfolder_help'] = 'Se definido como "sim", um botão será mostrado para permitir aos usuários baixar um arquivo zip contendo todos os arquivos.';
