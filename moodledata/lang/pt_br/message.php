...
/**
 * Strings for component 'message', language 'pt_br', branch 'MOODLE_31_STABLE'
 *
 * @package   message
...
$string['deletemessageconfirmation'] = 'Tem certeza de que deseja excluir esta mensagem? Ela só será excluída do seu histórico de mensagens e ainda poderá ser vista pelo usuário que enviou ou recebeu a mensagem.';
...
$string['messagetosend'] = 'Mensagem para enviar';
...
$string['sendingmessage'] = 'Enviando mensagem';
...
$string['unabletomessageuser'] = 'Você não tem permissão para enviar mensagens para este usuário';
