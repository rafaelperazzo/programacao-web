...
$string['discussionnownotsubscribed'] = '{$a->name} não irá ser notificado de novos posts em \'{$a->name}\' de \'{$a->forum}\'';
$string['discussionnowsubscribed'] = '{$a->name} será notificado de novos posts em \'{$a->name}\' de \'{$a->forum}\'';
